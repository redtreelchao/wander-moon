...
<table border="0" cellpadding="0" cellspacing="0" class="content_list"> 
    ...
    <tr class="tb_list" <?php if($row->status=='N'):?>style=" background:#F0F7FC"<?php endif?>>
      <td ><input type="checkbox" name="id[]" value="<?php echo $row->id?>">
        <?php echo $row->id?></td>
      <td >
      	<a href="<?php echo $this->createUrl('/site/specialDetail', array('id'=>$row['id'])); ?>" title="<?php echo $row->title; ?>" target="_blank" style="<?php echo $this->formatStyle($row->title_style);?>"><?php echo Helper::truncate_utf8_string($row->title, 15);?></a><br />
       </td>
      ...
      <td >
      	...
      	<a href="<?php echo  $this->createUrl('/site/specialDetail',array('id'=>$row['id']))?>" target="_blank"><img src="<?php echo $this->module->assetsUrl;?>/images/view.png" align="absmiddle" /></a>
      </td>
    </tr>
    <?php endforeach;?>
    <tr class="operate">

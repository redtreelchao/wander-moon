...
<table class="content_list">
    ...
    <tr class="tb_list" >
      ...
      <a href="<?php echo  $this->createUrl('batch',array('command'=>'commentDelete','id'=>$row->id))?>" onClick="return confirm('<?php echo Yii::t('admin','Confirm Delete');?>');"><img src="<?php echo $this->module->assetsUrl;?>/images/delete.png" align="absmiddle" /></a></td>
    </tr>
    <?php endforeach;?>
    <tr class="submit">

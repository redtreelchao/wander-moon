...
{		
	...
	{		
		...
		$SecMenus = array(
			...
			'3' => array(
					array('url'=> $this->createUrl('post/index'), 'name'=>Yii::t('admin','Post Manage')),
					...
					array('url'=> $this->createUrl('goodsPlan/index'), 'name'=>Yii::t('admin','Goods Plan Manage')),
					array('url'=> $this->createUrl('orders/index'), 'name'=>Yii::t('admin','Orders Manage')),
